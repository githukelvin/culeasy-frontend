...
<template>
  <div class="bg-[url('../assets/images/herobg.png')] bg-no-repeat bg-[center] bg-cover w-vw">
    <TheHeader />
    <div class="homecontent">
      <div class="hero w-vw">
        <HeroSection />
        <div
          class="searchBox mt-[5em] lg:w-9/12 flex flex-row lg:mx-auto bg-white border-y border-lightgray"
        >
